...
<head>
    ...
    <title>Admin - Edit existing Board</title>
            ...
            <div class="all-wrap bg_eee09">
                <c:choose>
                    <c:when test="${redirectPage =='board'}">
                        <a href="${contextPath}/admin/board?boardID=${itemIDtoEdit}">< back to board page</a>
                    </c:when>
                    <c:otherwise>
                ...
                <div class="container">
                    ...
                    <form:form method="POST" modelAttribute="boardForm" class="form-signin" action="/admin/editexistingboard">
                        <h3 class="form-signin-heading">Edit existing Board</h3>
                        ...
                        <h4 class="text-center">
                            <c:choose>
                                <c:when test="${redirectPage =='board'}">
                                    <a href="${contextPath}/admin/board?boardID=${itemIDtoEdit}">Cancel and back to board page</a>
                                </c:when>
                                <c:otherwise>
