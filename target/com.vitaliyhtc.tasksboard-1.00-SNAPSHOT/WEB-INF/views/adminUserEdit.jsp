...
<head>
    ...
    <title>Admin - Edit existing User</title>
                    ...
                    <c:otherwise>
                        <div class="container">
                            ...
                            <div class="bs-callout bs-callout-info" id="callout-help-text-accessibility">
                                <p>If you not need to change existing password for user - leave empty <code>password & confirm password</code> inputs.</p>
                            </div>

                            <form:form method="POST" modelAttribute="userForm" class="form-signin" action="/admin/editexistinguser">
                                <h3 class="form-signin-heading">Edit existing User account</h3>
